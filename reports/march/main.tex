...
for Buildroot it was sufficient to call the generic-package infrastructure.\\\\
...
\end{lstlisting}
The results are written to results/cl in JSON format, but they can be converted
to HTML (Fig.\ref{fig:html_output}) by running:
\begin{lstlisting}[language=sh]
