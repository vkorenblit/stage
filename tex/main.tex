...
The LLVM (Low Level Virtual Machine) project started in the year 2000 as a result
of a masters thesis \footnote{https://llvm.org/pubs/2002-12-LattnerMSThesis.html}
written by Chris Lattner at the University of Illinois. This project is different
from most traditional compiler projects (such as GCC) because it is not just a
