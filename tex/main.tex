...
contributors in LLVM. Such is the case of a contributor who is creating the
Chromium browser package, which relies on Clang to be built. This contribution
also adds lld, the system linker from the LLVM project which provides an
alternative to GNU ld and claims to be much faster than the latter one.\\\\
